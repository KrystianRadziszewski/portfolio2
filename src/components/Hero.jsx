		...
		<section className="relative pt-[120px]">
			...
			<div className="flex flex-col items-center gap-8 mb-16">
				<motion.h1 initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }} className="h1-text text-center leading-relaxed h-24">
					<span className="text-gradient">Cześć, jestem </span>
					<br />
				...
				<motion.p initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 1 }} className="description-text text-center lg:my-16">
					Koncetruje się na tworzeniu responsywnych stron/aplikacji oraz stron internetowych typu front-end. Podczas budowy korzystam z aktulanej dokumentacji dostępnej na oficjalnych stronach
					wybranych freamworków oraz z wykorzystaniem technik pod względem optymalizacji stron w przeglądarkach.
				</motion.p>
