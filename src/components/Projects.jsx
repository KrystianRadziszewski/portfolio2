...
const Projects = () => {
	...
	return (
		<section id="projects" className="relative py-[100px]">
			...
			<h2 className="h1-text my-3">Projekty</h2>
			<div className="text-white flex flex-row justify-center items-center gap-2 py-12">
				<ProjectTag onClick={handleTagChange} name="All" isSelected={tag === 'All'} title="Wszystkie" />
				<ProjectTag onClick={handleTagChange} name="Courses" isSelected={tag === 'Courses'} title="Kursy" />
				<ProjectTag onClick={handleTagChange} name="My" isSelected={tag === 'My'} title="Własne" />
			</div>
